...
parser$add_argument("--modelsPath",default="./test/",help="path to folder with ML models")
parser$add_argument("--vectorsPath", default="./vec_test/",help="path to folder with input vectors")
...
modelSTB <- load (modelSTB_SVMp)
modelTBE <- load (modelSTB_GBMp)
print(' ==> Checkpoint 2 ')
